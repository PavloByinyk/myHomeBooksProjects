package com.turtledev.simpleadapter_setviewtext_setviewimage;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // массив данных
        int[] values = { 8, 4, -3, 2, -5, 0, 3, -6, 1, -1, 0, 3, -6, 1, -1 };
        ...
        String [] from={ATTRIBUTE_NAME_VALUE,ATTRIBUTE_NAME_TEXT,ATTRIBUTE_NAME_IMAGE};

        int [] to ={R.id.tvValue,R.id.tvText,R.id.ivImg};

        MySingleAdapter mySingleAdapter=new MySingleAdapter(this,data,R.layout.item,from,to);
        lvSimple=(ListView)findViewById(R.id.lvSimple);
        lvSimple.setAdapter(mySingleAdapter);
    ...
    class MySingleAdapter extends SimpleAdapter{
        ...
        public MySingleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
